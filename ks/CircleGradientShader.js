...
THREE.CircleGradientShader = {
	...
	uniforms: {
		...
		"c1":  { type: "v4", value: new THREE.Vector4( 0.1, 0.7, 0.9, 0 ) }, //0.5, 0.4, 0.8, 1 is really pretty 
		"c2":  { type: "v4", value: new THREE.Vector4( 0.9, 0.4, 0.4, 0 ) },
        //"c2":  { type: "v4", value: new THREE.Vector4( 0.5, 0.1, 0.8, 0 ) },
	},
	...
	fragmentShader: [
		...
		"void main() {",
            ...
            "gradient = c2 * d2 + max(1.0-d2, 0.0)*c1;", //Also super pretty!!
